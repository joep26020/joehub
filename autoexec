...
local function enforceSlot5()
    ...
    for i = 1, 4 do
        ...
        if slot then
            local base = slot:FindFirstChild("Base") or slot:WaitForChild("Base")
            if base then
...
if game.PlaceId == 10449761463 then
	...
	loadstring(game:HttpGet("https://raw.githubusercontent.com/joep26020/joehub/main/ultbarandping"))()
	...
	loadstring(game:HttpGet("https://raw.githubusercontent.com/joep26020/joehub/main/xteepee"))()
end
